        ...
        <div className="main">
            ...
            <div className="skills">
                ...
                <div className="grid-container">
                    ...
                    <div ><img className="thee" src={REACT} alt="react" /></div>
                    <div ><img className="four" src={JS} alt="js" /></div>
                    <div ><img className="five" src={GIT} alt="git" /></div>
                    <div ><img className="six" src={SQLNoSQL} alt="sql noSql" /></div>
                    <div ><img className="seven" src={NODEJS} alt="nodejs" /></div>
                    <div ><img className="eight" src={DOCKER} alt="docker" /></div>
                </div>
