            ...
            <div id='projects' className="myprojects">
                ...
                <div className='freebox'>
                    ...
                    <div className="freeboxinfo">
                        ...
                        <a href="https://github.com/tiliax/MyFreebox_FE" target="_"><button>Frontend</button></a>
                        <a href="https://github.com/tiliax/MyFreebox_BE"><button>Backend</button></a>                        
                    </div>
                </div>
                {/* Pokefight */}
                <div className='pokefight'>
                    ...
                    <div className="pokefightinfo">
                        ...
                        <p><b>Links to my Repositories:</b></p>
                        <a href="https://github.com/tiliax/FE--PokeFight"><button>Frontend</button></a>
                        <a href="https://github.com/tiliax/FE--PokeFight"><button>Backend</button></a>            
                    </div>
                </div>
            </div>
            <hr />
