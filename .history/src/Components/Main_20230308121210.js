            ...
            <div id='projects' className="myprojects">
                ...
                <div className='freebox'>
                    ...
                    <div className="freeboxinfo">
                        <p>A <b>Freebox</b> is a giftbox with giveaways. With the Freebox App you can upload a freebox, tell what articles are in there and where and set a location. Like this others can check the map, see if there is a freebox in a specific region, see whats in there and go grab it. 
                        </p>
