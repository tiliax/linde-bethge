    ...
    return (
        ...
        <div className="main">
            ...
            <div className="skills">
                <h1>My Skills</h1>
                <div className="skillimageall"></div>
                <div className="skillimages1">
                    <img className="item" src={JS} alt="html" />
                    <img className="item" src={JS} alt="css" />
                    <img className="item" src={JS} alt="react" />
                    <img className="item" src={JS} alt="js" />
                </div>
                <div className="skillimage2">
                    <img className="item" src={JS} alt="git" />
                    <img className="item" src={JS} alt="sql noSql" />
