            ...
            <div id='projects' className="myprojects">
                ...
                <div className='freebox'>
                    ...
                    <div className="freeboxinfo">
                        <p>A <b>Freebox</b> is a giftbox with giveaways. With the Freebox App you can upload pictures, information and the location of the articles you want to give away. Others can check the map, see where is the nex freebox and go grab some articles they need or want. Like this articles can be reused 
                        </p>
