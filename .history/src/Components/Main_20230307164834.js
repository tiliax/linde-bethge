            ...
            <div id='contact' className="contact">
                ...
                <div className='contactinfo'>
                    ...
                    <div className='contacticons'>
                        ...
                        {/* <a href="https://www.linkedin.com/in/linde-bethge/" target="_blank"><img className='linkedin2' src={LINKEDINGRAU} alt="linkedin" /></a> */}
                        <a href="#"><img className='icon' src={MAIL} alt="" /></a>
                        <a href="#"><img className='icon' src={MAILGRAU} alt="" /></a>
                        <a href="https://github.com/tiliax" target="_blank"><img className='icon' src={GITHUB} alt="" /></a>
                    </div>
                </div>
            </div>
            <hr />
