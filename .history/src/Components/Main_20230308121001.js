            ...
            <div id='projects' className="myprojects">
                ...
                <div className='freebox'>
                    ...
                    <div className="freeboxinfo">
                        <p>A <b>Freebox</b> is a giftbox with giveaways. With the Freebox app you can upload a freebox, tell what articles are there to give away and where is the location. Like this other can c
                        </p>
