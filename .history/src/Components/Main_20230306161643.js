            ...
            <div id='projects' className="myprojects">
                ...
                <div className='pokefight'>
                    ...
                    <div className="pokefightinfo">
                        ...
                        <a href="https://github.com/tiliax/FE--PokeFight" target="_blank"><button>Backend</button></a>            
                    </div>
                </div>
            </div>
            <hr />
            ...
            <div id='contact' className="contact">
                ...
                <div className='contactinfo'>
                    ...
                    <div>
                        ...
                        <a href="#" target="_blank"><img className='mail' src={MAIL} alt="" /></a>
                        <a href="#" target="_blank"><img className='github' src={GITHUB} alt="" /></a>
                    </div>
                </div>
            </div>
            <hr />
