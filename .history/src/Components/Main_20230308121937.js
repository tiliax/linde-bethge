            ...
            <div id='projects' className="myprojects">
                ...
                <div className='freebox'>
                    ...
                    <div className="freeboxinfo">
                        <p>A <b>Freebox</b> is a giftbox with giveaways. With the Freebox App you can upload pictures, article informations and set a location. Others can check the map, see where is the next freebox located, whats in thereand go grab some articles they need or want. Like this articles can be found and reused.  
                        </p>
