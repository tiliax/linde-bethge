            ...
            <div className="myprojects">
                ...
                <div className='pokefight'>
                    ...
                    <div className="pokefightinfo">
                        <p>Freebox is an app for bla <b></b>Freebox is an app for bla Freebox is an app for bla Freebox is an app for bla Freebox is an app for bla Freebox is an app for bla Freebox is an app for bla Freebox is an app for bla Freebox is an app for bla Freebox is an app for bla.
                        </p>
                        <p><b>Technologies used: </b>HTML, CSS, React.js, NodeJS</p>
                        <p><b>Links to my Repositories:</b></p> <button>Frontend</button>
                        <button>Backend</button>                        
