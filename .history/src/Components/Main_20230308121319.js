            ...
            <div id='projects' className="myprojects">
                ...
                <div className='freebox'>
                    ...
                    <div className="freeboxinfo">
                        <p>A <b>Freebox</b> is a giftbox with giveaways. With the Freebox App you can upload pictures, , tell what articles are in there and where and set a location. Like this others can check the map, see where is the nex freebox and go grab some articles. 
                        </p>
