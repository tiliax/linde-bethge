            ...
            <div id='contact' className="contact">
                ...
                <div className='contactinfo'>
                    ...
                    <div className='contacticons'>
                        <a href="https://www.linkedin.com/in/linde-bethge/" data-src="https://www.linkedin.com/in/linde-bethge/" target="_blank"><img className='icon' src={LINKEDIN} alt="linkedin" /></a>
                        <a href="https://www.linkedin.com/in/linde-bethge/" target="_blank"><img className='iconhover' src={LINKEDINGRAU} alt="linkedin" /></a>
                        <a href="#"><img className='icon' src={MAIL} alt="mail" /></a>
                        <a href="#"><img className='iconhover' src={MAILGRAU} alt="mail" /></a>
