    ...
    return (
        ...
        <div className="main">
            ...
            <div className="skills">
                ...
                <img className="four" src={JS} alt="js" />                   <img className="five" src={GIT} alt="git" />                   <img className="six" src={SQLNoSQL} alt="sql noSql" />                   <img className="seven" src={NODEJS} alt="nodejs" />                   <img className="eight" src={DOCKER} alt="docker" />                </div>
