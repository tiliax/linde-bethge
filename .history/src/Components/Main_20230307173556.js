...
import GITHUBGRAU from './images/github_grau.png'
import MAIL from './images/mail.png'
import MAILGRAU from './images/mail_grau.png'
            ...
            <div id='contact' className="contact">
                ...
                <div className='contactinfo'>
                    ...
                    <div className='contacticons'>
                        <a href="https://www.linkedin.com/in/linde-bethge/" target="_blank"><img className='iconhover' src={LINKEDIN} alt="linkedin" /></a>
                        <a href="https://www.linkedin.com/in/linde-bethge/" target="_blank"><img className='icon' src={LINKEDINGRAU} alt="linkedin" /></a>
                        <a href="#"><img className='iconhover' src={MAIL} alt="mail" /></a>
                        <a href="#"><img className='icon' src={MAILGRAU} alt="mail" /></a>
                        <a href="https://github.com/tiliax" target="_blank"><img className='iconhover' src={GITHUB} alt="github" /></a>
                        <a href="https://github.com/tiliax" target="_blank"><img className='iconhover' src={GITHUBGRAU} alt="github" /></a>
                    </div>
                </div>
            </div>
            <hr />
